...
class Testing
{
    public static void main(String[] args) {
        Organization org = new Organization("Google",
        ...
        Employee e1 = new Employee("Tirth Patel",
                                   "18BCE243",
                                   "West Virginia, USA",
                                   org,
                                   "Software Engineer",
        ...
        Employee e2 = new Employee("Tirth Hi",
                                   "18BCE244",
                                   "Las Vegas, USA",
                                   org,
                                   "ML Engineer",
        ...
        Employee e3 = new Employee("Tirth R",
                                   "18BCE245",
                                   "East Viriginia, USA",
                                   org,
                                   "Graphics Engineer",
        ...
        Organization org2 = Organization.deserialize("Google.ser");
        org2.pPrint(true);
    }
}